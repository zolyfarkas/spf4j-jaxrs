 ...
 */
@Provider
@Produces({"application/stack.samples+json", "application/json"})
@Consumes({"application/stack.samples+json", "application/json"})
@Singleton
public final class SampleNodeMessageProviderJson
