...
public final class JsonAvroArrayMessageBodyReader extends AvroArrayMessageBodyReader {

  public JsonAvroArrayMessageBodyReader(final SchemaProtocol protocol) {
    super(protocol);
  }
