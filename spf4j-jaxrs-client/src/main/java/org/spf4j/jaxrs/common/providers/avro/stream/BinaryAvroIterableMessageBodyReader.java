...
public final class BinaryAvroIterableMessageBodyReader extends AvroIterableMessageBodyReader {

  public BinaryAvroIterableMessageBodyReader(final SchemaProtocol protocol) {
    super(protocol);
  }
