...
public final class JsonAvroStreamingMessageBodyReader extends AvroStreamingMessageBodyReader {

  public JsonAvroStreamingMessageBodyReader(final SchemaProtocol protocol) {
    super(protocol);
  }
